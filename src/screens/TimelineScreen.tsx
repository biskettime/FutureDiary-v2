  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.headerTitle}>🚀 미래일기 타임라인</Text>
      ...
      {todayEntries.length > 0 && (
        <View style={styles.todaySection}>
          <View style={styles.todaySectionTitleContainer}>
            <Text style={styles.todaySectionTitle}>☀️ 오늘 일어날 일!</Text>
            <Text style={styles.todayBadge}>Today</Text>
          </View>
          <Text style={styles.todaySectionSubtitle}>
      ...
      {timelineItems.length === 0 ? (
        <View style={styles.emptyContainer}>
          ...
          <TouchableOpacity
            ...
            <Text style={styles.emptyButtonText}>미래일기 쓰기</Text>
          </TouchableOpacity>
        </View>
      ) : (
        <FlatList
      ...
      <Modal
        ...
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            <Text style={styles.modalTitle}>실제 결과 기록</Text>
            ...
            <View style={styles.resultOptionContainer}>
              <TouchableOpacity
                ...
                <Text style={styles.resultOptionText}>이루어졌어요! 😊</Text>
                <Text style={styles.resultOptionDescription}>
                  예상했던 일이 실제로 일어났어요
                </Text>
              </TouchableOpacity>
            ...
            <View style={styles.detailInputContainer}>
              <Text style={styles.detailInputLabel}>
                실제로 일어난 일을 기록해주세요
              </Text>
              <TextInput
